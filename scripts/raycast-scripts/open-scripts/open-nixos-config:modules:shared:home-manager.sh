...
# @raycast.description open ~/.config/nix/modules/shared/home-manager.nix via emacsclient

FILE="/Users/alexeykotomin/.config/nix/modules/shared/home-manager.nix"
